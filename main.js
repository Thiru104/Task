...
function eswap(){
    ...
    document.querySelector(".inegrate-image").src="img/integrated/integrate2.png"
    document.querySelector(".e-commerce-store-parent").addEventListener("mouseout", function() {
        document.querySelector(".inegrate-image").src = "img/integrated/integrate1.png";
    });
}
function onlineswap(){
    
    document.querySelector(".inegrate-image").src="img/integrated/integrate3.png"
